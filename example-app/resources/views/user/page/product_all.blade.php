            ...
            <div class="list-filter flex flex-wrap mg-section">
                ...
                @foreach ($filter as $cate)
                    <div class="filter-item">
                        ...
                        <button data-id="{{$cate->filter[0]->filter_id}}" data-name="{{$cate->filter[0]->filter_name}}">{{$cate->filter[0]->filter_name}} </button>
                        <div class="list-filter-child">
                            <ul>
                                @foreach ($cate->filter[0]->childrentFilter as $filterchild)
                                    <li data-id="{{$filterchild->filter_id}}" data-name="{{$filterchild->filter_name}}" >{{$filterchild->filter_name}}</li>
                                @endforeach
                            </ul>
                            <div class="btn-filter-group">
                                <div class="btn btn-filter-close">Đóng</div>
                                <div  style="cursor: pointer" class="btn btn-filter-result">Xem kết quả</div>
                            </div>
                        </div>
        ...
        <div class="option-filter">
            ...
            <div class="list-filting">
                ...
                <ul class="list-filter flex flex-wrap mg-section">
                    <li >
                        <button class="delete-all"><span class="fas fa-close"></span> <span class="innter_filter">Bỏ chọn tất cả</span></button>
                    </li>
                </ul>
            </div>
        </div>
        <section class="ladi-section mg-section">
            ...
            <div class="ladi-list">
                ...
                @foreach ($product as $p)
                    <div class="ladi-item">
                     <a href="{{route('product',['slug' => $p->products['slug']])}}">
