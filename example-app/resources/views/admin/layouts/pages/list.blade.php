                ...
                <div class="form-feild">
                    ...
                    <form id="form-add" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Nhập tên Trang" class="form-control name" id="slug" onchange="ChangeToSlug()" name="name">
                            <p class="name-error text text-danger"></p>
                        </div>
                        <div class="form-group">
                            <label for="">Slug</label>
                            <input type="text" placeholder="Nhập tên Trang" class="form-control slug"  id="convert_slug" name="slug">
            ...
            <div class="box-alert">
                <div class="form-feild">
                    ...
                    <form class="form-edit" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Tên Trang</label>
                            <input type="text" placeholder="Nhập tên Trang" class="form-control name_edit" id="slug" onchange="ChangeToSlug()" name="name">
                            <p class="name-error text text-danger"></p>
                        </div>
                        <div class="form-group">
                            <label for="">Slug</label>
                            <input type="text" placeholder="Nhập tên Trang" class="form-control slug_edit"  id="convert_slug" name="slug">
                            <p class="slug-error text text-danger"></p>
                        </div>
                        <div class="form-group">
                            <label for="">Mô tả</label>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            function getDataTable() {
                    ...
                    "ajax": {
                        type: "GET",
                        url: "{{route('admin.pages.apiListPages')}}",
                        dataSrc: 'data'
                    },
                    "columns": [
                        {
                            ...
                            render: function(data,type,row,meta){
                                return `<input type="checkbox" class='item-check' id="item-check" name="item-check[]" value="${data.id_page}">`
                                // console.log(row)
                            }
                        },
                        {
                        ...
                        },
                        {
                            data:null,
                            render: function(data,type,row,meta){
                                return `<td><a  class="btn-delete"  data-id="${data.id_page}">Xoá</a></td>`
                            }
                        }
                    ],
                    language:{
        ...
        $('body').on('click','.btn-edit',function() {
            ...
            $.ajax(
                {
                    url: "{{route('admin.pages.editPages')}}",
                    dataType:"json",
                    method: "GET",
                    data: {id:id},
                    success: (res) => {
            ...
            $('.form-edit').submit(function(e){
                e.preventDefault();
                let name_page = $('.form-control.name_edit').val();
                ...
                formData.append('name',name_page)
                ...
                $.ajax({
                    type:"POST",
                    url: "{{route('admin.pages.putEditPages')}}",
                    data:formData,
                    success: (res) => {
                        if(res.status == 404){
        ...
        $('#form-add').submit(function(e) {
                ...
                let name_page = $('.form-control.name').val();
                ...
                $.ajax({
                    type:"POST",
                    url: "{{route('admin.pages.postAddPages')}}",
                    data:formData,
                    success: (res) => {
                        if(res.status == 404){
                            console.log(res)
