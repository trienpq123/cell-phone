                ...
                <div class="form-feild">
                    ...
                    <form id="form-add" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">ALT</label>
                            <input type="text" placeholder="Nhập tên Banner" class="form-control name" id="slug" onchange="ChangeToSlug()" name="name">
            ...
            <div class="box-alert">
                <div class="form-feild">
                    ...
                    <form class="form-edit" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">ALT</label>
                            <input type="text" placeholder="Nhập tên Banner" class="form-control name_edit" id="slug" onchange="ChangeToSlug()" name="name">
                            <p class="name-error text text-danger"></p>
                        </div>
                        <div class="form-group">
                            <label for="">Ảnh đại diện</label>
    ...
    <script>
                    ...
                    "columns": [
                        {
                            ...
                            render: function(data,type,row,meta){
                                return `<input type="checkbox" class='item-check' id="item-check" name="item-check[]" value="${data.id_banner}">`
                            }
                        },
                        {
                            data: null,
                            render: function(data,type,row,meta){
                                return `<img src="${data.link_img}" alt="${data.alt}" style="width:120px;height:120px">`
                            }
                        },
                        {
                            data: null,
                            render: function(data,type,row,meta){
                                return `<span>${data.alt}</span>`
                            }
                        },
                        {
                            data:null ,
                        ...
                        },
                        {
                            data:null,
                            render: function(data,type,row,meta){
                                return `<td><a  class="btn-delete"  data-id="${data.id_banner}">Xoá</a></td>`
                            }
                        }
                    ],
                    language:{
        ...
        $('body').on('click','.btn-edit',function() {
            ...
            $('.form-edit').submit(function(e){
                ...
                $.ajax({
                    type:"POST",
                    url: "{{route('admin.banner.putEditBanner')}}",
                    data:formData,
                    success: (res) => {
                        if(res.status == 404){
