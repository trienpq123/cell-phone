                ...
                <div class="form-feild">
                    ...
                    <form id="form-add" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="image"  class="file" id="upload-file">
...
@push('script-action')
            ...
            function getDataTable() {
                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            render: function(data,type,row,meta){
                                return `<a class="btn-edit"  data-name="edit-product" data-id="${data.id_category}">Chỉnh sửa</a>
                                <button class="btn-delete"  data-id="${data.id_category}">
                                        Xoá
                                    </button>`
                            }
                        },
    ...
    <script>
        $(document).ready(function(){
            ...
            let input[file] = event.target;
            if(input.files && input.file[0]){
                let reader = new FileReader();
                reader.onload = function(e){
                    let images =  $(".1").attr("src", e.target.result);
